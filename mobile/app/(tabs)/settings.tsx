...
const styles = StyleSheet.create({
  ...
  value: { color: "#302443", fontSize: 18 },
  codeRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  code: { color: "#302443", fontSize: 28, fontWeight: "800", letterSpacing: 3 },
  copyButton: {
  ...
  copyButtonText: { color: "#fcfaff", fontWeight: "700" },
  empty: { color: "#766889", paddingTop: 20 },
